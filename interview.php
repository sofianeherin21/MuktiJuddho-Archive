...
<ul>
	...
	<li><a href="blog.php">ব্লগ</a><?php session_start();
    ...
    <h2>সাক্ষাৎকারঃকিছু কথা তাদের মুখে</h2>
	<div class="article">
...
<br><br>	
 <div class="row">
  <div class="column">
    <div class="card">
      <img src="photos/km shafiullah.jpg" alt="1" style="width:100%">
      <div class="container">
        <h2>মেজর জেনারেল কে.এম শফিউল্লাহ</h2>
        <p class="title">কমান্ডার,সেকেন্ড ইস্ট বেঙ্গল রেজিমেন্ট</p>
        <p>যুদ্ধ চলাকালীন সশস্ত্র বাহিনীর ভূমিকা নিয়ে কথা বলেছেন।</p>
        <p>
  ...
  <div class="column">
    <div class="card">
      <img src="photos/haris.jpg" alt="2" style="width:100%">
      <div class="container">
        <h2>মোহাম্মদ হারিস</h2>
        ...
        <p><form action="https://www.google.com/">
		<button class="button" >বিস্তারিত</button>
		</form></p>
      </div>
    </div>
  ...
  <div class="column">
    <div class="card">
      <img src="photos/sharmila.jpg" alt="3" style="width:100%;height:202px">
      <div class="container">
        <h2>শর্মিলা বোস</h2>
        <p class="title">লেখক,1971:Bangladesh War</p>
  ...
  <div class="column">
    <div class="card">
      <img src="photos/prof shiraj.jpg" alt="4" style="width:100%">
      <div class="container">
        <h2>প্রফেসর সিরাজুল ইসলাম চৌধুরী</h2>
        <p class="title">অধ্যাপক,ঢাকা বিশ্ববিদ্যালয়</p>
        <p>যুদ্ধ চলাকালীন পাকিস্তান বাহিনীর বুদ্ধিজীবী হত্যাকান্ডের মাধ্যমে বাংলাদেশকে একটি পঙ্গু রাষ্ট্রে পরিণত করার নীলনকশা সম্পর্কে কথা বলেছেন।</p>
        <p><form action="https://www.google.com/">
		<button class="button" >বিস্তারিত</button>
		</form></p>
      </div>
  ...
  <div class="column">
    <div class="card">
      <img src="photos/baloch.jpg" alt="5" style="width:100%;height:202px">
      <div class="container">
  ...
  <div class="column">
    <div class="card">
      <img src="photos/asad.jpg" alt="6" style="width:100%;height:202px">
      <div class="container">
        <h2>রাইসুল ইসলাম আসাদ</h2>
        <p class="title">অভিনেতা এবং মুক্তিযোদ্ধা</p>
...
<div style="float:left;height:0;padding-bottom:32.0%;margin:0 25px;border:2px solid white"><iframe src="https://www.youtube.com/embed/-a3ptlo-seI?ecver=2" width="560" height="360" frameborder="0" style="left:0;float:left" allowfullscreen></iframe></div>
	...
	<p style="font-size:40px">সাক্ষাৎকারঃভারতের তৎকালীন প্রধানমন্ত্রী ইন্দিরা গান্ধী</p>
...
<div class="line" style="background-color:white;height:5px">
<h2 style="padding-top:40px">আরও কিছু ভিডিও সাক্ষাৎকার</h2>
</div> 
